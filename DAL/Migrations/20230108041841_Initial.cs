    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    reaction_ref = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    reaction_type = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    reaction_description = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    role_ref = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    permission_description = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    rolesrole_ref = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_utilisateur", x => x.utilisateur_id);
                    table.ForeignKey(
                        name: "FK_utilisateur_role_rolesrole_ref",
                        column: x => x.rolesrole_ref,
                        principalTable: "role",
                        principalColumn: "role_ref",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    comment_reference = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    reaction_ref = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    comment_ref_pk = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    reaction_ref_pk = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idpostref = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    reaction_ref_pk = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    post_ref_pk = table.Column<string>(type: "nvarchar(255)", nullable: false),
                    reaction_count = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_utilisateur_rolesrole_ref",
                table: "utilisateur",
                column: "rolesrole_ref");
