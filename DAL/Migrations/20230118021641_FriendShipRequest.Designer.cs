...
namespace DAL.Migrations
{
    ...
    [Migration("20230118021641_FriendShipRequest")]
    partial class FriendShipRequest
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BL.Models.FriendshipRequest", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BL.Models.FriendshipRequest", b =>
                {
                    b.HasOne("BL.Models.Utilisateur", "receiver")
                        .WithMany()
                        .HasForeignKey("receiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BL.Models.Utilisateur", "sender")
                        .WithMany()
